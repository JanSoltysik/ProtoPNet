...
from lenet5_features import lenet5_features
...
class PPNet(nn.Module):
    ...
    def __init__(self, features, img_size, prototype_shape,
        ...
        if features_name.startswith('VGG') or features_name.startswith('RES') or features_name.startswith("LENET"):
        ...
        if add_on_layers_type == 'bottleneck':
            ...
            self.add_on_layers = nn.Sequential(
                nn.Conv2d(in_channels=first_add_on_layer_in_channels, out_channels=self.prototype_shape[1], kernel_size=4),
                nn.ReLU(),
                nn.Conv2d(in_channels=self.prototype_shape[1], out_channels=self.prototype_shape[1], kernel_size=4),
                nn.Sigmoid()
                )
