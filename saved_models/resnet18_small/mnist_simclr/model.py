...
class PPNet(nn.Module):
    ...
    def __init__(self, features, img_size, prototype_shape,
        ...
        # read the cluster centers created by simCLR
        prototype_vectors = torch.load('centers.pt').to(dtype=torch.float)
        assert prototype_vectors.shape == prototype_shape
        # initialize prototype vectors with cluster centers created by simCLR
        self.prototype_vectors = nn.Parameter(prototype_vectors,
                                              requires_grad=True)
